...
export declare const Pressable: import("react").ForwardRefExoticComponent<Pick<import(".").StyledProps<import("react-native").PressableProps & import("react").RefAttributes<RNView>>, "tw" | "key" | "className" | "baseClassName" | "baseTw" | keyof import("react-native").PressableProps> & import("react").RefAttributes<RNView>>;
